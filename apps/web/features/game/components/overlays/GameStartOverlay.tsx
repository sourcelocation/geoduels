...
export default function GameStartOverlay({
  ...
  const content = (
    <div className="absolute inset-0 flex flex-col items-center justify-center">
      ...
      <div className="absolute top-12 flex flex-col items-center">
        ...
        />
        <h1 className="font-hud text-display-md md:text-display-lg text-content-primary drop-shadow-md mb-1">
          Round {roundNumber}
        </h1>
        <h2 className="font-hud text-heading-md text-content-primary drop-shadow-md">
          {modeName}
        </h2>
        {mapName && (
          <h3 className="font-hud text-label italic text-content-secondary uppercase tracking-display mt-1">
            {mapName}
          </h3>
        )}
      </div>
  ...
  return (
    <motion.div
      ...
      className="absolute inset-0 z-game-overlay pointer-events-none overflow-hidden"
    >
