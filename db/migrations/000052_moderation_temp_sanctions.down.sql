...
alter table moderation_verdicts
  ...
  add constraint moderation_verdicts_enforcement_action_check
    check (enforcement_action is null or enforcement_action in ('warning', 'temporary_ban', 'permanent_ban', 'report_mute', 'unban', 'refund'));
...
alter table enforcement_actions
  add constraint enforcement_actions_type_check
    check (action_type in ('warning', 'temporary_ban', 'permanent_ban', 'report_mute', 'unban', 'refund'));
