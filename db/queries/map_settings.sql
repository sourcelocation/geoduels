...
INSERT INTO site_settings(key, value_json, updated_at) VALUES ($1, convert_from(sqlc.arg(value_json), 'UTF8')::jsonb, now()) ON CONFLICT (key) DO UPDATE SET value_json=excluded.value_json, updated_at=now();
